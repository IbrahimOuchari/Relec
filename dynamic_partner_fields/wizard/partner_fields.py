...
class PartnerDynamicFields(models.TransientModel):
    ...
    field_type = fields.Selection(selection='get_possible_field_types', string='Type Champ', required=True)
    ttype = fields.Selection(string="Type Champ", related='field_type')
