...
class PurchaseOrderLinePriceHistory(models.TransientModel):
    ...
    purchase_order_line_id = fields.Many2one(
        ...
        string="Ligne de Commande d'Achat",
    ...
    line_ids = fields.One2many(
        ...
        string="Historique par Ligne",
        readonly=True,
    )
    include_rfq = fields.Boolean(
        string="Inclure les Demandes de Prix",
        help="Inclure les Demandes de Prix dans l'historique",
    )
    include_commercial_partner = fields.Boolean(
        string="Inclure les Contacts Liés",
        default=True,
        help="Inclure l'entité commerciale et ses contacts dans l'historique des achats",
    )
