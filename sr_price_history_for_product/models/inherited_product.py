...
class ProductTemplate(models.Model):
    ...
    sale_price_history_ids = fields.Many2many("sr.sale.price.history",string="Historique Prix Achat",compute="_get_sale_price_history")
    purchase_price_history_ids = fields.Many2many("sr.purchase.price.history",string="Historique Prix Achat", compute="_get_purchase_price_history")
...
class ProductProduct(models.Model):
    ...
    sale_price_history_ids = fields.Many2many("sr.sale.price.history",string="Historique Prix Vente",compute="_get_sale_price_history")
    purchase_price_history_ids = fields.Many2many("sr.purchase.price.history",string="Historique Prix Achat", compute="_get_purchase_price_history")
